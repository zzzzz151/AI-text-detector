...
class Language_Model:
    """
    Uses one of the models described in the above dictionary

    Use get_probability to analyze text
    Use get_model_name to know which model you are using
    """
...
if __name__ == '__main__':
    def test_while_loop(model: Language_Model):
        while True:
            input_text = input("Input text: ")
            if not input_text:
                break
            print(f"Probability of being computer-generated: {model.get_probability(input_text)[0]}")
    ...
    probs = model.get_probability(batched_input_text)
