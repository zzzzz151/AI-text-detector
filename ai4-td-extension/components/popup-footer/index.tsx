        ...
        <Box position={"sticky"} bottom={0} bgcolor={'background.paper'}>
            ...
            <ThemeProvider theme={mutedTheme}>
                ...
                <Button 
                    ...
                    target="_blank"
                >
                    <svg style={{marginRight: '4px', paddingBottom: '2px'}} stroke= "#6d758d" width="28" height="28" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M14.438 10.063v8.75m4.374-4.375h-8.75m13.126 0a8.75 8.75 0 1 1-17.5 0 8.75 8.75 0 0 1 17.5 0z" strokeWidth=".875" strokeLinecap="round" strokeLinejoin="round"></path></svg>
                    PDF Viewer
                </Button>
            </ThemeProvider>
        </ButtonGroup>
